...
from KrakenConsts import KRAKEN_CUSTOM_DB_JOB_TEMPLATE, KRAKEN_CUSTOM_DB_SCRIPT_COMMAND,\
    ...
    PATH_TO_DB_VALIDATOR_SCRIPT, PATH_TO_CUSTOM_GENOME_DOWNLOAD_SCRIPT, PATH_2_PYTHON_ACTIVATE
import pathlib
...
class KrakenCustomDbCreator:
    ...
    @staticmethod
    def create_custom_db(user_unique_id: str, path_to_fasta_file: pathlib.Path, list_of_taxaids: list, list_accession_number):
        """
